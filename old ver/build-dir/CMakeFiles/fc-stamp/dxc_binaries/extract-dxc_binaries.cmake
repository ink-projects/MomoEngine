...
#
get_filename_component(filename "C:/Users/Momo/Desktop/Momo Engine/build-dir/_deps/dxc_binaries-tmp/dxc_2024_07_18.zip" ABSOLUTE)
get_filename_component(directory "C:/Users/Momo/Desktop/Momo Engine/build-dir/_deps/dxc_binaries-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-dxc_binaries${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-dxc_binaries${i}")
